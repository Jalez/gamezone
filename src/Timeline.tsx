...
import UnassignedDescriptions from './UnassignedDescriptions';
...
const Timeline = () => {
    ...
    function handleDragEnd(result: any) {
        ...
        draggedItem = emptyTimeline[sourceIndex].description.splice(result.source.index, 1)[0];
        ...
        items[destinationIndex].description.splice(result.destination.index, 0, draggedItem);
